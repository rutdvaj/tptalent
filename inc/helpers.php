...
function tp_default($section) {
    $defaults = [
        ...
        'tp_testimonial' => [
            ...
            'rotator' => [
                ['name' => 'A Fortune 500 company', 'desc' => 'Sports', 'metric' => '+38% fill-rate'],
                ['name' => 'A Big 4 company', 'desc' => 'IT & Consulting', 'metric' => '120 hires in 90 days'],
                ['name' => 'A global automation leader', 'desc' => 'IT & Consulting', 'metric' => '−31% attrition'],
                ['name' => 'A global IT services leader', 'desc' => 'IT & Consulting', 'metric' => '4.1x ROI'],
                ['name' => 'A global technology consultancy', 'desc' => 'IT & Consulting', 'metric' => '24h SLA response'],
                ['name' => 'A global digital transformation partner', 'desc' => 'IT & Consulting', 'metric' => '+52% retention'],
                ['name' => 'A global enterprise IT partner', 'desc' => 'IT & Consulting', 'metric' => '2,000+ placements'],
                ['name' => 'A global technology partner', 'desc' => 'IT & Consulting', 'metric' => '8 markets entered'],
            ],
