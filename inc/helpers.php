...
function tp_default($section) {
    $defaults = [
        ...
        'tp_case_study' => [
            ...
            'sourcing_body' => 'Dedicated account management, domain-focused recruiters and weekly hiring governance kept multidisciplinary technology talent flowing into a brand-new engineering center — without adding vendors.',
            ...
            'cta_card_text' => 'The full center build-out plan, discipline coverage and retention numbers — inside the case study.',
